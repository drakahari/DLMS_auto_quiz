...
<div class="settings-page-shell">
    ...
    <div class="settings-hub-grid">
        ...
        <div class="settings-hub-card is-coming">
            ...
            <div class="settings-hub-copy">
                <div class="settings-card-kicker">COMING NEXT</div>
    ...
    <div class="settings-migration-note">
        <strong>Step 1 migration:</strong>
        Only Appearance has moved. AI, parsing, data cleanup, and factory reset remain fully available on Current / Legacy Settings.
    </div>
</div>
</body>
</html>
