...
<div class="settings-page-shell">
    ...
    <div class="settings-migration-note">
        <strong>Step 3 migration:</strong>
        Appearance, AI Integration, and Parsing now have dedicated settings pages. Data cleanup and factory reset remain fully available on Current / Legacy Settings.
    </div>
</div>
</body>
</html>
